...
namespace FileDiffer
{
    ...
    internal sealed class DiffFilesCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("deb78c2c-c653-419a-902c-0cfc3391e4b4");
        ...
        {
            var items = GetSelectedGiles(dte);
        ...
        public static IEnumerable<string> GetSelectedGiles(DTE2 dte)
        {
